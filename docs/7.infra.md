...
- [Structurizr DSL](7.서버구조설계-infra_구성도.dsl)


## ✅ INFRA Image

### 1. System Context (User ↔ System)
- [System Context](7.서버구조설계-infra_구성도_SystemContext.jpg)


### 2. Container View (서비스 내부 구조)
- [Container View](7.서버구조설계-infra_구성도_Container.png)


### 3. Deployment View (Production 인프라)
- [Production](7.서버구조설계-infra_구성도_Production_1.png)
- [Production](7.서버구조설계-infra_구성도_Production_2.png)
